...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_inserirTCC`(titulo varchar(100), resumo varchar(250), statusTCC tinyint(1), objetivo varchar(100), justificativa varchar(100), TCCTipo tinyint(1), idLinhaPesquisaFK integer(11), idProfessorFK INTEGER (11), idAlunoFK1 INTEGER (11), idAlunoFK2 INTEGER (11))
BEGIN
  INSERT INTO `e-star`.`TCC`
(`titulo`,
`resumo`,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listarTCC`()
BEGIN
